//
//  ShrinkHeaderStyle.swift
//  SocialMedia
//

import SwiftUI

/// Header elements shrink as the header scrolls out of view. An optional fade parameter can be enabled for content to discreetly fade away
/// in addition to shrinking. This is typically applied to the title view or its elements.
