...
<p align="left">
	...
	<img src="./Preview/ProfileScreen_Replies_Screenshot.png" width="180" height="400"/>
	<img src="./Preview/ProfileScreen_EditProfile_Screenshot.png" width="180" height="400"/>
...
## Description
This project aims to replicate the core functionalities of any popular social media app, emphasizing user authentication, post creation, real-time updates using firebase listeners, and a user-friendly interface built with SwiftUI. It leverages Firebase's robust backend services for seamless data management and real-time interactions.
